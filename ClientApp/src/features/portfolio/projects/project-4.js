      ...
      <div id="ajax-page" className="ajax-page-content">
          <div className="ajax-page-wrapper">
              <div className="ajax-page-nav">
                  ...
                  <a href="#denzelawuah-portfolio" onClick={() => dispatch(nextProjectPage(3))} className="nav-anim"  data-animation="62"><i className="lnr lnr-chevron-left"></i></a>
                      <a href="#java" onClick={() => dispatch(nextProjectPage(5))} className="nav-anim"  data-animation="63"><i className="lnr lnr-chevron-right"></i></a>
                  </div>

          ...
          <div className="ajax-page-wrapper">
              <div className="ajax-page-nav">
                  <div className="nav-item ajax-page-prev-next">
                      <a href="#angularSite" onClick={() => dispatch(nextProjectPage(2))} className="nav-anim"  data-animation="62"><i className="lnr lnr-chevron-left"></i></a>
                      <a href="#crm" onClick={() => dispatch(nextProjectPage(4))} className="nav-anim"  data-animation="63"><i className="lnr lnr-chevron-right"></i></a>
                  </div>

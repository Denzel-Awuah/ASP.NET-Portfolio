...
class Project3 extends React.PureComponent<ProjectProps> {
    ...
    public render() {
        ...
        return (
            ...
            <section data-id="denzelawuah-portfolio" className="animated-section">
                    ...
                    <div className="ajax-page-wrapper">
                        <div className="ajax-page-nav">
                            <div className="nav-item ajax-page-prev-next">
                                <a href={this.props.leftArrowHref} onClick={() => { this.props.angular(); }} className="nav-anim" data-animation="27"><i className="lnr lnr-chevron-left"></i></a>
                                <a href={this.props.rightArrowHref} onClick={() => { this.props.crm(); }} className="nav-anim" data-animation="27"><i className="lnr lnr-chevron-right"></i></a>

...
class Project2 extends React.PureComponent<ProjectProps> {
                    ...
                    <div className="ajax-page-wrapper">
                        <div className="ajax-page-nav">
                            <div className="nav-item ajax-page-prev-next">
                                    <a href={this.props.leftArrowHref} onClick={() => { this.props.react(); }} className="nav-anim" data-animation="27"><i className="lnr lnr-chevron-left"></i></a>
                                    <a href={this.props.rightArrowHref} onClick={() => { this.props.denzel(); }} className="nav-anim" data-animation="27"><i className="lnr lnr-chevron-right"></i></a>

...
"use strict";
    ...
    function init(options) {
        ...
        $(".lmpixels-arrow-right").click(function() {
            ...
            activeItem.next("li").children("a").attr("data-animation", "22");
            var aI = $('.main-menu a.active').parent("li");
            aI.next("li").children("a").click();
            //activeItem.next("li").children("a").click();
            if ( activeItem.is(':last-child') ) {
                $('.main-menu li:first-child').children("a").click();
            }

                //aI.next("li").children("a").removeAttr("data-animation");
        ...
        $(".lmpixels-arrow-left").click(function() {
            var activeItem = $('.main-menu a.active').parent("li");
            activeItem.prev("li").children("a").attr("data-animation", "22");
            var aI = $('.main-menu a.active').parent("li");
            aI.prev("li").children("a").click();
            if ( activeItem.is(':first-child') ) {
                $('.main-menu li:last-child').children("a").click();
            }

                 //activeItem.prev("li").children("a").removeAttr("data-animation");
        });
    }
    ...
    function Animate($pageTrigger, gotoPage) {
        ...
        switch(selectedAnimNumber) {
            ...
            case 21:
                ...
                break;
            case 22:
                inClass = 'animated-section-scaleUp animated-section-delay100';
